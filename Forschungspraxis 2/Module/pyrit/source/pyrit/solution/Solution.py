...
class TransientSolution(Solution, ABC):
    ...
    def _get_solution(self, *, time=None, index=None) -> np.ndarray:
        """Return the solution.
    ...
    def _set_solution(self, solution: np.ndarray, *, time=None, index=None):
        """Set the solution.
    ...
    def _interpolate_solution(self, time: float) -> np.ndarray:
        ...
        return np.sum(weights * self._solution[indices])
